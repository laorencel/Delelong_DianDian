...
public class RegisterFrag extends Fragment implements View.OnClickListener {
    private static final String URL_REGISTER = "http://192.168.4.103:8080/Jfinal/api/register";
    private static final String URL_SMSCODE = "http://192.168.4.103:8080/Jfinal/api/smscode";
    //验证码类型
