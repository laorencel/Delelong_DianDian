package com.delelong.baidumaptest.fragment;
...
import com.delelong.baidumaptest.LoginActivity;
import com.delelong.baidumaptest.MainActivity;
import com.delelong.baidumaptest.R;
import com.delelong.baidumaptest.utils.MD5;
...
public class LoginFrag extends Fragment implements View.OnClickListener {
    ...
    private static final String URL_LOGIN = "http://192.168.4.103:8080/Jfinal/api/login";
    View view;
    ...
    private void initView() {
        ...
        String preferenceName = preferences.getString("name", null);
        if (preferenceName != null) {
            edt_phone.setText(preferenceName);
        }
    }

    String name, pwd_edt, pwd;
    ...
    private void login() {
        if (name.isEmpty() || pwd.isEmpty()) {
            ...
            if (name.length() != 11 || pwd.length() < 6) {
                ...
                List<String> result = activity.loginApp(URL_LOGIN, name, pwd);
